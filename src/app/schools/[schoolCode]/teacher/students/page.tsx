  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-xl font-bold tracking-tight">Student Administration</h2>
          <p className="text-muted-foreground text-xs">
            Review, add, edit, and archive student profiles for {school.name}.
          </p>
        </div>
      ...
      <div className="bg-card rounded-xl border border-border overflow-hidden shadow-sm">
        <div className="px-6 py-4 border-b border-border">
          <h3 className="font-bold text-sm text-foreground">Student Directory ({students.length})</h3>
        </div>
